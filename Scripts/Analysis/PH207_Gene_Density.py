#!/usr/bin/env python
"""Calculate gene density in sliding windows across the PH207 genome. Takes two
arguments:
    1) Genes GFF
    2) Reference.fai file (from samtools faidx)
...
def main(genes, fai, winsize=1000000, step=500000):
    """Main function."""
    c_lengths = get_chrom_len(fai)
    gene_pos = parse_gff(genes)
    #   Print a header
    print 'Chromosome\tMidpoint\tGenesPerMb'
