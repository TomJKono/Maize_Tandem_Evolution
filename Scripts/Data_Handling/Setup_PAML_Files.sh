...
BKTFLT="/Volumes/LaCie/Maize_Tandem_Evolution/Orthofinder/BKT_Filtered"
MARK_SCRIPT="/Users/tomkono/Dropbox/GitHub/Maize_Tandem_Evolution/Scripts/Data_Handling/Mark_Trees_For_CodeML.py"
TREES="/Volumes/LaCie/Maize_Tandem_Evolution/Orthofinder/Trees_FLT"
...
do 
    ...
    sed -f ${SP_NAME} ${BKTFLT}/${i}_BKT_50Flt.fa > ${PAML_IN_DIR}/${i}/Null/${i}_BKT.fa
    sed -f ${SP_NAME} ${BKTFLT}/${i}_BKT_50Flt.fa > ${PAML_IN_DIR}/${i}/Ha1/${i}_BKT.fa
    sed -f ${SP_NAME} ${BKTFLT}/${i}_BKT_50Flt.fa > ${PAML_IN_DIR}/${i}/Ha2/${i}_BKT.fa
    sed -f ${SP_NAME} ${BKTFLT}/${i}_BKT_50Flt.fa > ${PAML_IN_DIR}/${i}/Ha3/${i}_BKT.fa
done
