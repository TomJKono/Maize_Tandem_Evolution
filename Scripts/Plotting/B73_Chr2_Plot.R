...
b73_tandem <- read.table("/Users/tomkono/Dropbox/GitHub/Maize_Tandem_Evolution/Data/B73_True_Tandem_Positions.gff", header=FALSE, sep="\t")
...
ph207_tandem <- read.table("/Users/tomkono/Dropbox/GitHub/Maize_Tandem_Evolution/Data/PH207_True_Tandem_Positions.gff", header=FALSE)
...
# Plot for B73
p1 <- ggplot(NULL) +
    geom_rect(data=b73_m1, aes(xmin=Start/1000000, xmax=End/1000000, ymin=0, ymax=100), fill="#b2df8a") +
    geom_rect(data=b73_m2, aes(xmin=Start/1000000, xmax=End/1000000, ymin=0, ymax=100), fill="#a6cee3") +
    geom_line(data=b73_gene_te, aes(x=Midpoint/1000000, y=GenesPerMb), color="black", size=0.5) +
    geom_line(data=b73_gene_te, aes(x=Midpoint/1000000, y=DNATEsPerMb), color="#ff7f00", size=0.5) +
    geom_line(data=b73_gene_te, aes(x=Midpoint/1000000, y=RNATEsPerMb), color="#e31a1c", size=0.5) +
    geom_segment(data=b73_tandem, mapping=aes(x=Start/1000000, xend=Start/1000000, y=100, yend=80), color="#984ea3", size=0.25) +
    scale_y_continuous(name="Features Per Mb", breaks=seq(0, 90, 30), labels=seq(0, 90, 30)) +
...
p2 <- ggplot(NULL) +
    geom_rect(data=ph207_m1, aes(xmin=Start/1000000, xmax=End/1000000, ymin=0, ymax=100), fill="#b2df8a") +
    geom_rect(data=ph207_m2, aes(xmin=Start/1000000, xmax=End/1000000, ymin=0, ymax=100), fill="#a6cee3") +
    geom_line(data=ph207_gene, aes(x=Midpoint/1000000, y=GenesPerMb), color="black", size=0.5) +
    geom_segment(data=ph207_tandem, mapping=aes(x=Start/1000000, xend=Start/1000000, y=100, yend=80), color="#984ea3", size=0.25) +
    scale_y_continuous(name="Features Per Mb", breaks=seq(0, 90, 30), labels=seq(0, 90, 30)) +
    scale_x_continuous(name="Physical Position (Mb)", breaks=seq(0, 300, 50), labels=seq(0, 300, 50)) +
    theme_bw() +
    theme(
